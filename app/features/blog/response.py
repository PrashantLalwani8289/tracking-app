...
class GPT:
    ...
    def query(self, input: str) -> list:
        ...
        prompt = f"""
        {{
            "task": "Generate a detailed travel guide for a specific destination based on the provided input.Provide only the details of the input_destination, the below example are for your refrence to understand the type of ouptut. And do not add any *"backslash n"* or break lines",
