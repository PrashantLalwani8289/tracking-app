...
from app.features.subscribers.repository import contact_form, sub_for_newsletter
...
async def subscribe(request : ContactFormSchema, db: Session = Depends(db_connection)):
